          ...
          <div className="flex h-16 items-center">
            ...
            <div className="ml-4 flex lg:ml-0">
              <Link to="/" className="flex items-center">
                ...
                <img src="/images/g200.png" className="h-8 w-8 mr-2 mb-2" />
            ...
            {isLoggedIn ? (
              <div className={"flex items-center justify-center"}>
                ...
                >
                  <img
                    ...
                    alt={""}
                    className={
                      "h-8 -my-1.5 text-sm font-medium text-gray-700 hover:text-gray-800 rounded-2xl"
                    }
                  />
                  <div
                    className={
                      "h-8 -my-1 text-lg font-medium text-gray-800 underline decoration-1"
                    }
                  >
                ...
                <div
                  onClick={logout}
                  className={
                    "h-6 text-sm font-medium text-gray-700 hover:text-gray-800 hover:cursor-pointer"
                  }
                >
                  Logout
                </div>
              ...
              <div>
                ...
                <span
                  className="h-6 w-px bg-gray-200 mr-4"
                  aria-hidden="true"
                />
                <Link
                  to="/signup"
